...
import * as eventSlice from "@/application/features/events/store/slices/eventListsSlice";
import * as selectors from "@/application/features/events/store/selectors/eventsListsSelectors";
