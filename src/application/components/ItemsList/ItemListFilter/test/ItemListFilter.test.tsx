...
import ItemsListFilter from '../../ItemListFilter/ItemsListFilter';
import { ASC } from '../../ItemListFilter/ItemsListFilter.types'
...
vi.mock('@/application/components/ui/SearchInput/SearchInput', () => ({
