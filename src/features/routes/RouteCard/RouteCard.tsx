...
const RouteCard = ({ route, extras }: RouteCardProps) => {
  ...
  return <div className=" grid-cols-3 routeCard bg-background cursor-pointer p-5 border-t border-primary mb-8 grid relative pt-10"
    ...
    <h2 className="row-start-1 row-end-2 col-start-1 col-end-4 sm:text-2xl text-ellipsis">{ route.name } </h2>
    ...
    <SimpleMap className="w-full justify-self-end row-start-5 row-end-6 col-start-1 col-end-4 z-10 mt-2" 
